...
extension LanguageModelQuerySortBy
  ...
  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> sortByColorCode() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LanguageModelQuerySortThenBy
  ...
  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> thenByColorCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorCode', Sort.asc);
    });
  }
  ...
  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<LanguageModel, LanguageModel, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension LanguageModelQueryWhereDistinct
  ...
  QueryBuilder<LanguageModel, LanguageModel, QDistinct> distinctByColorCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LanguageModel, LanguageModel, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LanguageModelQueryProperty
  ...
  QueryBuilder<LanguageModel, String?, QQueryOperations> colorCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'colorCode');
    });
  }

  QueryBuilder<LanguageModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
